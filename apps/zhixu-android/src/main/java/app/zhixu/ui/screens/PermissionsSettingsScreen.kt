...
fun PermissionsSettingsScreen(
    ...
    Scaffold(
        ...
        topBar = {
            Column {
                ZhixuTopAppBar(
                    ...
                    title = { Text(stringResource(R.string.settings_permissions_title), style = MaterialTheme.typography.titleMedium) },
                    navigationIcon = {
        ...
        LazyColumn(
            ...
            item {
                SectionTitle(text = stringResource(R.string.settings_notifications_section_status))
            }
                ...
                Card(
                    ...
                    SettingsRow(
                        ...
                        onClick = {
                            ...
                            if (!postNotificationsGranted && Build.VERSION.SDK_INT >= 33) {
            ...
            item {
                SectionTitle(text = stringResource(R.string.settings_notifications_section_reminders))
            }
            ...
            item {
                SectionTitle(text = stringResource(R.string.nav_pomodoro))
            }
            ...
            item {
                Card(
                    ...
                    SettingsRow(
                        ...
                        title = context.getString(R.string.nav_pomodoro) + "设置",
                        subtitle = stringResource(R.string.settings_permissions_pomodoro_subtitle),
                    ...
                    SettingsRow(
                        ...
                        subtitle = stringResource(R.string.settings_permissions_notification_subtitle),
